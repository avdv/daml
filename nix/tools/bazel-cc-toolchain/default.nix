  ...
  cc-darwin =
    wrapCCWith rec {
      ...
      extraBuildCommands = with darwin.apple_sdk.frameworks; ''
        ...
        echo "-isystem ${llvmPackages_10.libcxx.dev}/include/c++/v1" >> $out/nix-support/cc-cflags
        echo "-isystem ${llvmPackages_10.clang-unwrapped.lib}/lib/clang/${cc.version}/include" >> $out/nix-support/cc-cflags
        ...
        echo "-L${llvmPackages_10.libcxx}/lib" >> $out/nix-support/cc-cflags
