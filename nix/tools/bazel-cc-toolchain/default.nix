  ...
  cc-darwin =
    wrapCCWith rec {
      ...
      extraBuildCommands = with darwin.apple_sdk.frameworks; ''
        ...
        echo "-isystem ${llvmPackages_11.libcxx.dev}/include/c++/v1" >> $out/nix-support/cc-cflags
        echo "-isystem ${llvmPackages_11.clang-unwrapped.lib}/lib/clang/${cc.version}/include" >> $out/nix-support/cc-cflags
        ...
        echo "-L${llvmPackages_11.libcxx}/lib" >> $out/nix-support/cc-cflags
